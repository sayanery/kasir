                ...
                <div class="col-auto">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="peg_catalog.php">Semua Kategori</a>
                            <?php foreach ($categories as $cat): ?>
                                <a class="dropdown-item" href="peg_catalog.php?category=<?= urlencode($cat); ?>"><?= $cat; ?></a>
                            <?php endforeach; ?>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <form action="peg_catalog.php" method="GET" class="form-inline">
                        <input type="hidden" name="category" value="<?= $category; ?>">
                        <input class="form-control mr-sm-2" type="search" name="search" placeholder="Cari produk" aria-label="Search" value="<?= htmlspecialchars($search); ?>">
